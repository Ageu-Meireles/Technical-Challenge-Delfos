...
async def get_data(
    ...
    variables: Optional[List[Literal["wind_speed", "power", "ambient_temperature"]]] = Query(None, description="Variables to include in the response (default: all)",),
    ...
    include_ambient_temperature = variables is None or "ambient_temperature" in variables
